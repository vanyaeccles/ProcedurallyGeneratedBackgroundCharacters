...
// This is the 'master' class for all agents, handles navigation, running the action heirarchy + performing actions

public class Character : MonoBehaviour
{

    //set `isLogging' to false if running simulation for a long time, 
    //if an agent's action log is too long the text mesh will throw an exception
    ...
    void Awake()
    {
        ...
        interrupt = GetComponent<Interrupt>(); 
    ...
    {
        isActive = !isActive;
        interrupt.isActive = !interrupt.isActive;
    }
    ...
    public void ReceiveSocialiseNice(Relationship rel)
    {
        ...
        rel.relationshipValue.value +=  2.0f * UtilityTime.time; //@TODO, fix amount
    } 
